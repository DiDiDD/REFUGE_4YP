...
if __name__ == "__main__":
    ...
    batch_size = 5
    lr = 1e-3
    checkpoint_path = "/home/mans4021/Desktop/checkpoint_2.pth"
    ...
    model = SwinUNETR(img_size=(512, 512), in_channels=3, out_channels=2, use_checkpoint=True, spatial_dims=2)
