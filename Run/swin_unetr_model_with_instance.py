...
class SwinUNETR_instance(nn.Module):
    """
...
class SwinTransformerBlock(nn.Module):
    ...
    def __init__(
        ...
        drop_path: float = 0.0,
        act_layer: str = "GELU",
        norm_layer: type[InstanceNorm2d] = nn.InstanceNorm2d,
        use_checkpoint: bool = False,
    ) -> None:
        """
        Args:
...
class PatchMergingV2(nn.Module):
    ...
    def __init__(self, dim: int, norm_layer: type[InstanceNorm2d] = nn.InstanceNorm2d, spatial_dims: int = 3) -> None:
        """
        Args:
            dim: number of feature channels.
            norm_layer: normalization layer.
